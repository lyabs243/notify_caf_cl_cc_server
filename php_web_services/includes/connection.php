 	...
 	header("Content-Type: text/html;charset=UTF-8");
		...
		{	
			//local  
				 ...
				 DEFINE ('DB_NAME', 'all_in_one_news_app');
		}
		else
		{
			//local live 

 			 DEFINE ('DB_USER', 'notifygrlznotigr');
			 DEFINE ('DB_PASSWORD', 'dbhtrfy3ntGr');
			 DEFINE ('DB_HOST', 'notifygrlznotigr.mysql.db');           //host name depends on server
			 DEFINE ('DB_NAME', 'notifygrlznotigr');
		}
